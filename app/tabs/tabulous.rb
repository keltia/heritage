...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #---------------------------------------------------------------------------------------------------------------#
#      [    :as_photos_tab        ,    'As Photos'        ,    as_photos_path        ,    true        ,    true        ],
#      [    :as_users_tab         ,    'As Users'         ,    as_users_path         ,    true        ,    true        ],
#      [    :as_stories_tab       ,    'As Stories'       ,    as_stories_path       ,    true        ,    true        ],
#      [    :as_emails_tab        ,    'As Emails'        ,    as_emails_path        ,    true        ,    true        ],
      [    :stories_tab          ,    'Stories'          ,    stories_path          ,    true        ,    true        ],
      [    :photographers_tab    ,    'Photographers'    ,    photographers_path    ,    true        ,    true        ],
      #---------------------------------------------------------------------------------------------------------------#
      #    TAB NAME              |    DISPLAY TEXT       |    PATH                  |    VISIBLE?    |    ENABLED?    #
      #---------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #----------------------------------------------------------------------#
#      [    :as_photos        ,    :all_actions    ,    :as_photos_tab        ],
#      [    :as_users         ,    :all_actions    ,    :as_users_tab         ],
#      [    :as_stories       ,    :all_actions    ,    :as_stories_tab       ],
#      [    :as_emails        ,    :all_actions    ,    :as_emails_tab        ],
      [    :stories          ,    :all_actions    ,    :stories_tab          ],
      [    :photographers    ,    :all_actions    ,    :photographers_tab    ],
      #----------------------------------------------------------------------#
      #    CONTROLLER        |    ACTION          |    TAB                   #
      #----------------------------------------------------------------------#
    ]
